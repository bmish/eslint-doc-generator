...
| `--check`                    | Whether to check for and fail if there is a diff. Any diff will be displayed but no output will be written to files. Typically used during CI. Diffs omit ANSI colors when `NO_COLOR` is set or stderr is not a TTY.                                                      | `false`                                                                                                                                                                                                        |
